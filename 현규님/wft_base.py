...
# path = "D:/aihub/136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Validation/01.원천데이터/*"
...
# # 2. 텍스트 파일 경로 취합
# path = "D:/aihub/136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/*"
...
# train_testvalid = ds.train_test_split(test_size=0.999)
...
# low_call_voices.push_to_hub("Dearlie/wt")

# Hub로부터 전처리가 완료된 데이터셋을 로드
from datasets import load_dataset
low_call_voices_prepreocessed = load_dataset("Dearlie/wt")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="whisper-base",  # 원하는 리포지토리 이름을 임력한다.
...
trainer = Seq2SeqTrainer(
    ...
    eval_dataset=low_call_voices_prepreocessed["test"],  # or "test"
...
#     "language": "ko",
#     "model_name": "Whisper Base Ko - Dearlie",  # a 'pretty' name for our model

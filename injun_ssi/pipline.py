...
#tokenizer = DistilBertTokenizerFast.from_pretrained('distil-base-uncased',token='') # 허깅페이스 토큰 필요 https://huggingface.co/docs/huggingface_hub/main/ko/guides/cli 


from transformers import DistilBertTokenizerFast 

#mod = AutoModel.from_pretrained("distilbert-base-uncased", use_auth_token="")
